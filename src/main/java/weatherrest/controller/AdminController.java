...
public class AdminController {
    ...
    public WeatherData saveRandomOne() {
        ...
        WeatherData weatherData = new WeatherData(LocalDate.of(1985, 1, 1), 36.1189, -86.6892, generatingRandomAlphabeticString10(), generatingRandomAlphabeticString10(), new float[]{17.3f, 16.8f, 16.4f, 16.0f, 15.6f, 15.3f, 15.0f, 14.9f, 15.8f, 18.0f, 20.2f, 22.3f, 23.8f, 24.9f, 25.5f, 25.7f, 24.9f, 23.0f, 21.7f, 20.8f, 29.9f, 29.2f, 28.6f, 28.1f});
    ...
    public WeatherData creatOne() {
        ...
        WeatherData weatherData = new WeatherData(LocalDate.of(1985, 1, 1), 36.1189, -86.6892, "Nashville", "Tennessee", new float[]{17.3f, 16.8f, 16.4f, 16.0f, 15.6f, 15.3f, 15.0f, 14.9f, 15.8f, 18.0f, 20.2f, 22.3f, 23.8f, 24.9f, 25.5f, 25.7f, 24.9f, 23.0f, 21.7f, 20.8f, 29.9f, 29.2f, 28.6f, 28.1f});
        return weatherRepository.save(weatherData);
